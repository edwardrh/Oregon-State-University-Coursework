...
//#include "pattern.vert"
//#include "pattern.frag"
...
Display( )
{
	...
	if (Textures != 0) {
		...
		//glRotatef(360*Time, 0., 0.25, 0.25);
		...
		Pattern->Use();
		//Pattern->SetUniformVariable("uS0", T0);
		//Pattern->SetUniformVariable("uT0", S0);
