...
int		Light0On;				// ! = 0 mean light0 is on
int		Light1On;				// ! = 0 mean light1 is on
int		Light2On;				// ! = 0 mean light2 is on
GLuint	SphereList;				// sphere display list
GLuint	TeapotList;				// teapot display list
GLuint	CubeList;				// cube display list
...
InitLists( )
{
	...
	glNewList(TeapotList, GL_COMPILE);
		...
		SetMaterial(1., .54, 0., 50.);
		glColor3f(1., .54, 0.);
		//glutSolidTeapot(2.);
		glutSolidSphere(1.75, 20., 20.);
	...
	//glLoadIdentity();
		...
		//SetSpotLight(GL_LIGHT2, 0., 0., 0., 1., 1., 1., 1., 1., 1.);
